...
// logout_button.addEventListener("click", logout_button_onclick);
...
function getFirstName() {
  return new Promise((resolve, reject) => {
    fetch(`/name`, {
      ...
      .then(data => {
        console.log('Name Success:', data[0].firstName);
        document.getElementById("username").textContent = data[0].firstName + '!';
