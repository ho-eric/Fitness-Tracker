...
module.exports = {
  ...
  insertIntoProfileTable: insertIntoProfileTable,
...
const getProfileName = "SELECT firstName From ProfileTable WHERE userId = ?";
const all_AT = "select * from ActivityTable where userId = ?";
const all_PT = "select * from ProfileTable where userId = ?";
...
async function insertIntoProfileTable(userId, firstName) {
  try {
    let results = await db.run(insertProfile, [userId, firstName]);
    return results;
  }
  catch (error) {
    console.log(error);
...
async function getFirstName(userId) {
  try {
    let result = await db.get(getProfileName, [userId]);
    console.log("Got name:", result.firstName);
...
async function getAllProfiles() {
  try {
    let results = await db.all("select * from ProfileTable", []);
    return results;
  }
  catch (error) {
    console.log(error);
...
async function getAllActivityID(userId) {
  try {
    let results = await db.all(all_AT, [userId]);
    return results;
  }
  catch (error) {
    console.log(error);
...
async function getAllProfileID(userId) {
  try {
    let results = await db.all(all_PT, [userId]);
    return results;
  }
  catch (error) {
    console.log(error);
